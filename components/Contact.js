  ...
  return (
    <FlexContainer $firstSection $direction="column" key="contact" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} $noMbPadding>
      <ContactContainer>
        ...
        <p>
          Para realizar una compra, envíanos un mensaje por WhatsApp o un correo electrónico a <strong>ventas@stellar.tienda.cl</strong> <br/> A partir de ahí finalizamos con boleta o factura y organizaremos el envío.
