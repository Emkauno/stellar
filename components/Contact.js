  ...
  return (
    <FlexContainer $firstSection $direction="column" key="contact" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} $noMbPadding>
      <ContactContainer>
        ...
        <p>
          Para realizar una compra, envíanos un mensaje por WhatsApp o un correo electrónico a <strong>ventas@stellar.cl</strong> <br/> A partir de ahí finalizamos con boleta o factura y organizaremos el envío.

        </p>
        <a href="mailto:stellar.spa.cl@gmail.com">Contactar Ahora
          <Image src="/email.svg" width={24} height={24} />
        </a>
      </ContactContainer>
    </FlexContainer>
  );
